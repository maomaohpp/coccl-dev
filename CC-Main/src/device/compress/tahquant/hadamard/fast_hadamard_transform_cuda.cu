...
template void fast_hadamard_transform_cuda<__half>(HadamardParamsBase &params, cudaStream_t stream);
template void fast_hadamard_transform_cuda<__nv_bfloat16>(HadamardParamsBase &params, cudaStream_t stream);
