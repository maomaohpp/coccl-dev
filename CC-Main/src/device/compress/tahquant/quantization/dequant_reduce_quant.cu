        ...
        if (in_num_bits == 8) {
            if (out_num_bits == 8){
                if (num_gpus == 1) {
                    ...
                    LAUNCH_DEQUANT_REDUCE_QUANT_IMPL(8, 8, 2, quantize::Type::Asymmetric);
                } else if (num_gpus == 4) {
                    LAUNCH_DEQUANT_REDUCE_QUANT_IMPL(8, 8, 4, quantize::Type::Asymmetric);
                } else if (num_gpus == 8) {
                    LAUNCH_DEQUANT_REDUCE_QUANT_IMPL(8, 8, 8, quantize::Type::Asymmetric);
                } else if (num_gpus == 16) {
                    LAUNCH_DEQUANT_REDUCE_QUANT_IMPL(8, 8, 16, quantize::Type::Asymmetric);
                } else {
                    LAUNCH_DEQUANT_REDUCE_QUANT_IMPL(8, 8, -1, quantize::Type::Asymmetric);
                }
            }
