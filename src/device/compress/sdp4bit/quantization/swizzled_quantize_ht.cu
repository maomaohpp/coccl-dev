...
template <int numBits, int totalChunks, int threads, quantize::Type quantType>
__global__ void swizzled_quant_kernel_float_ht(int8_t* quantized_data,
                                            float* quantized_scales,
                                ...
                                cudaStream_t stream)
{
    ...
    if (threads == 32) {
        LAUNCH_SWIZZLE_QUANT_FLOAT_HT(2, 32);
    } else if (threads == 64) {
        LAUNCH_SWIZZLE_QUANT_FLOAT_HT(2, 64);
    } else if (threads == 128) {
        LAUNCH_SWIZZLE_QUANT_FLOAT_HT(2, 128);
    } else if (threads == 256) {
        LAUNCH_SWIZZLE_QUANT_FLOAT_HT(2, 256);
    } else if (threads == 512) {
        if (total_unroll == 2) {
            LAUNCH_SWIZZLE_QUANT_FLOAT_HT(2, 512);
        } else if (total_unroll == 4) {
            LAUNCH_SWIZZLE_QUANT_FLOAT_HT(4, 512);
        } else if (total_unroll == 6) {
            LAUNCH_SWIZZLE_QUANT_FLOAT_HT(6, 512);
        } else if (total_unroll == 8) {
            LAUNCH_SWIZZLE_QUANT_FLOAT_HT(8, 512);
        } else if (total_unroll == 10) {
            LAUNCH_SWIZZLE_QUANT_FLOAT_HT(10, 512);
        }
    }
}
